...
export function BookingWidget({
  ...
  useEffect(() => {
    ...
    async function loadBookingData() {
      ...
      setError('')
      try {
        const res = await fetch(`/api/public/booking?locationId=${locationId}`)
    ...
    async function loadSlots() {
      ...
      try {
        ...
        const res = await fetch(
          `/api/public/booking/slots?stylistId=${selectedStylist.id}&date=${dateStr}&locationId=${locationId}`
        )
